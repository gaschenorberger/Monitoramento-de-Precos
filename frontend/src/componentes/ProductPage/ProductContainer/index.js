...
function ProductContainer({nome_produto, categoria, avaliacoes, nAvaliacoes}) {
            ...
            <main>
                <div className="breadcrumb">
                    <h3 className="breadcrumbText">
                        <Link to="/">Home</Link> <span className="arrowIcon">›</span> <a className="categoria">{categoria}</a>
                    </h3>
                </div>
